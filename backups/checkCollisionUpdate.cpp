			...
			if(POne->pos.y >= PTwo->pos.y){
				if(PTwo->jumping == false){
					...
					if(getPlayerDist()<0.90f*(PTwo->getRad()+POne->getRad())){
						float slope2 = (PTwo->pos.y-POne->pos.y)/(PTwo->pos.x-POne->pos.x);
						float angle2 = atan(slope2);
						float xDist2 = cos(angle2)*(PTwo->getRad()+POne->getRad());
						float yDist2 = sin(angle2)*(PTwo->getRad()+POne->getRad());
						if(slope2<0.0f){
							yDist2*=-1.0f;
							xDist2*=-1.0f;
						}
						PTwo->pos.x = POne->pos.x + xDist2;
						PTwo->pos.y = POne->pos.y + yDist2;
					}
				}
				...
				if(PTwo->jumping == false){
					...
					if(getPlayerDist()<0.9*(PTwo->getRad()+POne->getRad())){
						...
						POne->pos.x = PTwo->pos.x + xDist2;
						POne->pos.y = PTwo->pos.y + yDist2;
					}
				}
				else if(PTwo->jumping == true){
					POne->canMoveDown = true;
			...
			if(POne->pos.y >= PTwo->pos.y){
				...
				if(PTwo->jumping == false){
					...
					if(getPlayerDist()<0.9*(PTwo->getRad()+POne->getRad())){
						...
						POne->pos.x = Two->pos.x + xDist2;
						POne->pos.y = Two->pos.y + yDist2;
					}
				}
				else if(PTwo->jumping == true){
					POne->canMoveDown = true;
